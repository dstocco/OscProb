...
if(NOT TARGET Eigen3::Eigen)
  ...
  FetchContent_Declare(
    ...
    # is installed on the system, via the OS, or a package manager SOURCE_SUBDIR
    # cmake)
    EXCLUDE_FROM_ALL FIND_PACKAGE_ARGS)
  FetchContent_MakeAvailable(Eigen3)
endif()

# if(NOT TARGET Eigen3::Eigen) add_library(Eigen3::Eigen INTERFACE IMPORTED)
# set_target_properties(Eigen3::Eigen PROPERTIES INTERFACE_INCLUDE_DIRECTORIES
# ${eigen3_SOURCE_DIR}) set(EIGEN3_INCLUDE_DIR ${eigen3_SOURCE_DIR}) endif()
